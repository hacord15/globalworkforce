    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-brand-grey-500 text-lg mt-5 max-w-4xl mx-auto leading-relaxed">
  Every candidate placed through SIS Global, undergoes structured training and readiness evaluation,
  <br />
  before international deployment. This ensures seamless operations run without disruption.
</p>
        </div>
  ...
  >
    ...
    <div className="relative w-full h-44 rounded-xl overflow-hidden mb-6 shadow-sm">
      <Image
        ...
        className="object-cover object-center"
      />
      {/* Stronger 3-stop gradient overlay for text readability */}
      <div className="absolute inset-0 bg-gradient-to-t from-brand-grey-900/80 via-brand-grey-900/30 to-transparent" />
  ...
  >
    ...
    <div className="relative w-full h-44 rounded-xl overflow-hidden mb-6 shadow-sm">
      <Image
        ...
        className="object-cover object-center"
      />
      {/* 3-stop gradient overlay – strong at bottom for text clarity */}
      <div className="absolute inset-0 bg-gradient-to-t from-brand-grey-900/80 via-brand-grey-900/30 to-transparent" />
      <p className="absolute bottom-3 left-4 text-white text-lg font-semibold drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)]">
