...
function Section({ id, title, children }: { id: string; title: string; children: React.ReactNode }) {
  return (
    <section id={id} className="mb-10 scroll-mt-24">
      <h2
        className="text-2xl font-bold text-brand-grey-900 mb-4 pb-3 border-b border-brand-grey-100"
    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{ background: "linear-gradient(160deg,#171717 0%,#262626 100%)" }}
        >
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 60% 80% at 90% 30%, rgba(200,16,46,0.12) 0%, transparent 70%)",
              }}
            />
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-10 items-start">
              ...
              <aside className="lg:sticky lg:top-24 hidden lg:block">
                  ...
                  <nav className="p-2">
                    {TOC.map((item) => (
                      <a
                        key={item.id}
                        href={`#${item.id}`}
                        className="block px-3 py-2 rounded-lg text-xs font-medium text-brand-grey-600 hover:text-brand-red hover:bg-brand-grey-50 transition-colors"
                      >
                        {item.label}
                      </a>
                    ))}
                ...
                >
                  ...
                  <p className="text-white/70 text-xs leading-relaxed mb-4">
                    You can update your cookie preferences at any time through your browser settings.
                  </p>
                  <Link
                    href="/contact"
              ...
              {/* Body */}
              <div
                className="bg-white rounded-3xl border border-brand-grey-200 p-6 sm:p-10 shadow-sm"
              ...
              >
                ...
                <div className="mb-10 pb-8 border-b border-brand-grey-100">
                  <p className="text-sm text-brand-grey-600 leading-relaxed">
                    This Cookie Policy explains how SIS Global Workforce Solutions Private Limited
                    (&quot;we&quot;, &quot;us&quot;, or &quot;Company&quot;) uses cookies and similar
                    tracking technologies when you visit our website at{" "}
                    <a
                      href="https://sisglobalworkforce.com"
                      className="text-brand-red hover:underline"
                    >
                      sisglobalworkforce.com
                    </a>
                ...
                <Section id="what" title="1. What Are Cookies?">
                  <p>
                    ...
                    efficiently, to remember your preferences, and to provide information to website
                    owners.
                  </p>
                  <p>
                    Cookies can be &quot;first-party&quot; (set by us) or &quot;third-party&quot; (set
                    by services we use, such as Google Analytics). They may also be:
                  </p>
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            ...
                            style={{
                              background: c.canOpt ? "#FFF0F2" : "#F0FFF4",
                              color: c.canOpt ? "#C8102E" : "#0BA02C",
                            }}
                          >
                            {c.canOpt
                          ...
                          <div className="flex flex-wrap gap-1 mt-2">
                            {c.examples.map((e) => (
                              <span
                                key={e}
                                className="text-[10px] px-2 py-0.5 rounded-full bg-white border border-brand-grey-200 text-brand-grey-500"
                              >
                                {e}
                              </span>
                            ))}
                    ...
                    <table className="w-full text-xs border-collapse">
                      <thead>
                        <tr style={{ background: "#FFF5F6" }}>
                          <th className="text-left px-4 py-3 font-bold text-brand-grey-800 text-xs uppercase tracking-wider rounded-tl-lg">
                            Cookie Name
                          </th>
                          <th className="text-left px-4 py-3 font-bold text-brand-grey-800 text-xs uppercase tracking-wider">
                            Type
                          </th>
                          <th className="text-left px-4 py-3 font-bold text-brand-grey-800 text-xs uppercase tracking-wider">
                            Duration
                          </th>
                          <th className="text-left px-4 py-3 font-bold text-brand-grey-800 text-xs uppercase tracking-wider rounded-tr-lg">
                            Purpose
                          </th>
                        </tr>
                      </thead>
                ...
                <Section id="third" title="4. Third-Party Cookies">
                  <p>
                    ...
                    not control these cookies and they are subject to the privacy policies of the
                ...
                <Section id="manage" title="5. Managing Your Cookies">
                  ...
                  <p>
                    Most browsers allow you to control cookies through their settings. The links
                    below explain how to manage cookies in common browsers:
                  </p>
                  <ul className="mt-2 space-y-2">
                    <Bullet>
                      <a
                ...
                <Section id="consent" title="6. Your Consent">
                  <p>
                    When you first visit our website, we display a cookie consent banner. By clicking
                    &quot;Accept All&quot;, you consent to all categories of cookies. You may also
                    click &quot;Manage Preferences&quot; to accept only selected categories.
                  </p>
                  <p>
                    Where required by law, we only deploy non-essential cookies (analytics,
                    functional, marketing) with your explicit consent. You may withdraw or update
                    your consent at any time by clearing cookies in your browser and revisiting our
                    website.
                  </p>
                </Section>
                ...
                <Section id="changes" title="7. Changes to This Policy">
                  <p>
                    ...
                    technology, law, or our data practices. We will notify you of significant changes
                    by posting a notice on our website or, where appropriate, by email. The
                    &quot;Last updated&quot; date at the top shows when it was last revised.
                  </p>
                </Section>

                <Section id="contact" title="8. Contact Us">
                  <p>
                    If you have questions about our use of cookies or wish to exercise your rights,
                    contact us:
                  </p>
                  <div className="grid sm:grid-cols-2 gap-4 mt-5">
                    <a
                      href="mailto:info@sisglobalworkforce.com"
                      className="flex items-center gap-3 p-4 rounded-xl border border-brand-grey-200 hover:border-brand-red/30 hover:shadow-sm transition-all group"
                    >
                      <div
                      ...
                      <div>
                        <p className="text-xs text-brand-grey-400 font-semibold uppercase tracking-widest mb-0.5">
                          Email
                        </p>
                        <p className="text-sm font-bold text-brand-grey-800 group-hover:text-brand-red transition-colors break-all">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-brand-grey-800 group-hover:text-brand-red transition-colors">
                          sisglobalworkforce.com
                        </p>
                      </div>
                    </a>
