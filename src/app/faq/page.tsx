...
export const FAQS: FAQ[] = [
  ...
  { id: 4,  category: "general",   question: "Is SIS Global Workforce Solutions a listed company?",    answer: "SIS Global Workforce Solutions is a subsidiary of SIS India Ltd., which is listed on both the NSE and BSE. The parent group generates over ₹15,982 crore in annual revenue and employs 3,57,022 professionals across its verticals." },
  ...
  // For Job Seekers
  { id: 6,  category: "seekers",   question: "How do I apply for a job on SIS Global?",               answer: `You can browse all open positions on our Find Jobs page. Select any listing, review the job description, and choose “Apply Now”. You will be asked to complete a short application form and upload your CV` },
  { id: 7,  category: "seekers",   question: "Is it free to apply for jobs?",                         answer: "Yes, completely free. SIS Global Workforce Solutions never charges candidates any registration, application, or placement fee. If anyone asks you for money on our behalf, please report it immediately to info@sisglobalworkforce.com." },
  ...
  { id: 11, category: "seekers",   question: "Will I receive feedback after an interview?",           answer: "We strive to provide timely feedback after every interview stage. Your dedicated recruitment consultant will inform you of the outcome. If you have not heard back within five business days of an interview, please contact your assigned consultant or email seekers@sisglobalworkforce.com." },
  ...
  { id: 21, category: "billing",   question: "What is your refund and cancellation policy?",          answer: "Service fees for completed placements are non-refundable. For contracts cancelled before commencement, any prepaid amounts (less administrative costs) are refunded within 15 working days. Please refer to your Master Service Agreement for full terms." },
  ...
  { id: 23, category: "account",   question: "How do I reset my password?",                           answer: "Select “Forgot Password” on the login page and enter your registered email address." },
